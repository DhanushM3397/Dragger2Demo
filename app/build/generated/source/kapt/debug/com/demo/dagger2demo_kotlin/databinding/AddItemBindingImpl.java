...
public class AddItemBindingImpl extends AddItemBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.alertText, 1);
        sViewsWithIds.put(R.id.userName, 2);
        sViewsWithIds.put(R.id.simpleCheckBox, 3);
    }
    // views
    @NonNull
    ...
    public AddItemBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private AddItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
