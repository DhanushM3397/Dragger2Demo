...
import com.demo.dagger2demo_kotlin.di.AppModule_ProvideBaseUrlFactory;
import com.demo.dagger2demo_kotlin.di.AppModule_ProvideRetrofitInstanceFactory;
...
public final class DaggerMyApplication_HiltComponents_SingletonC extends MyApplication_HiltComponents.SingletonC {
  ...
  private Provider<RetroServiceInterface> provideRetrofitInstanceProvider;
  ...
  private void initialize(final ApplicationContextModule applicationContextModuleParam) {
    this.provideRetrofitInstanceProvider = DoubleCheck.provider(new SwitchingProvider<RetroServiceInterface>(singletonC, 0));
  }
  ...
  private static final class ViewModelCImpl extends MyApplication_HiltComponents.ViewModelC {
    ...
    private MainActivityViewModel mainActivityViewModel() {
      return new MainActivityViewModel(singletonC.provideRetrofitInstanceProvider.get());
    }
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.demo.dagger2demo_kotlin.MainActivityViewModel", (Provider) mainActivityViewModelProvider);
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.demo.dagger2demo_kotlin.MainActivityViewModel 
  ...
  private static final class SwitchingProvider<T> implements Provider<T> {
    ...
    public T get() {
      switch (id) {
        case 0: // com.demo.dagger2demo_kotlin.api.RetroServiceInterface 
